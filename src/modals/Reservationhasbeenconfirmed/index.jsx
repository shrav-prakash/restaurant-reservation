            ...
            <div className="flex flex-col justify-start w-full">
              ...
              <div className="flex md:flex-col flex-row font-poppins md:gap-5 items-center justify-start md:ml-[0] ml-[34px] mt-12 w-[95%] md:w-full">
                ...
                <div className="flex flex-col gap-5 items-center justify-start ml-28 md:ml-[0] w-[24%] md:w-full">
                  <Button className="bg-light_blue-A700_6c cursor-pointer min-w-[246px] py-7 rounded-[20px] text-center text-indigo-900 text-xl">
                    Modify
                  </Button>
                  <Button
                    className="common-pointer bg-red-A700_63 cursor-pointer min-w-[246px] py-[29px] rounded-[20px] text-center text-red-A700 text-xl"
