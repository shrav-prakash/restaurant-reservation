            ...
            <div className="flex flex-col justify-start w-full">
              ...
              <div className="flex md:flex-col flex-row font-poppins md:gap-5 items-center justify-start md:ml-[0] ml-[34px] mt-12 w-[95%] md:w-full">
                ...
                <div className="flex flex-col gap-[30px] items-center justify-start ml-28 md:ml-[0] w-[24%] md:w-full">
                  <Button className="bg-red-400 cursor-pointer min-w-[246px] py-[29px] rounded-[20px] text-center text-white-A700 text-xl">
                    Cancel
                  </Button>
                  <Button
                    className="common-pointer bg-gray-400_64 cursor-pointer min-w-[246px] py-[29px] rounded-[20px] text-center text-gray-900 text-xl"
