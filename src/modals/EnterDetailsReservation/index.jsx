              ...
              <div className="flex md:flex-1 flex-col gap-[23px] items-start justify-start md:mt-0 mt-1.5 w-[48%] md:w-full">
                ...
                <div className="flex flex-col gap-6 items-center justify-start w-full">
                  <Input
                    ...
                    className="p-0 placeholder:text-gray-500 sm:pr-5 text-gray-500 text-left text-xl w-full"
                    wrapClassName="bg-white-A700 border border-gray-400 border-solid pl-4 pr-[35px] py-[15px] rounded-lg w-full"
                    type="text"
                  ></Input>
                  <Input
                    name="Lastname"
                  ...
                  ></Input>
                  <SelectBox
                    className="bg-white-A700 border border-gray-400 border-solid pl-4 py-[15px] rounded-lg text-gray-500 text-left text-xl w-full"
                ...
                <Button
                  className="common-pointer bg-red-400 cursor-pointer min-w-[475px] sm:min-w-full py-4 rounded-lg sm:text-[21px] md:text-[23px] text-[25px] text-center text-white-A700"
